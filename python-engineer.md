...
You will work directly with the founders and with the doctors who use the system.
...
- Production Python: services that other people depend on, not scripts
- Solid API design, and the judgement to keep an interface small
- Comfort on Linux and with a cloud platform: deployment, networking, debugging what you cannot see
- Care with data: schemas, migrations, idempotency, and knowing what to do when a message arrives twice
- Plain writing, because decisions in a regulated field have to be explained

Useful, not required: healthcare data standards, message queues and event-driven systems, working with LLM APIs, Sinhala or Tamil language data.
